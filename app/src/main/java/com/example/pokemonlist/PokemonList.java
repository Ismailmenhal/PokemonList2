...
import com.example.pokemonlist.Adapter.PokeAdapter;
import com.example.pokemonlist.Retrofit.RetrofitClient;
import com.example.pokemonlist.Retrofit.interfacePokeman;
...
public class PokemonList extends Fragment {
    ...
    interfacePokeman ipoke;
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    RecyclerView pokemonView;
    ...
    public PokemonList() {
        ...
        ipoke = retrofit.create(interfacePokeman.class);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pokemonView = (RecyclerView) view.findViewById(R.id.pokemonsView);
        pokemonView.setHasFixedSize(true);
        pokemonView.setLayoutManager(new GridLayoutManager(getActivity(),3));
        ItemOffsetDecoration itemOffsetDecoration = new ItemOffsetDecoration(getActivity(),R.dimen.spacing);
        pokemonView.addItemDecoration(itemOffsetDecoration);
    ...
    private void fetchData(){
        compositeDisposable.add(ipoke.getPokemons()
                ...
                .subscribe(new Consumer<PokeDex>() {
                    ...
                    public void accept(PokeDex pokeDex) throws Exception {
                        ...
                        PokeAdapter adapter = new PokeAdapter(getActivity(),Common.commonPokemonList);
